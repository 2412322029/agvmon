...
data_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "util", "data")
...
def setup_static_files(app: FastAPI):
    ...
    robot_img_dir = os.path.join(data_dir, "robot_img")
    if os.path.exists(robot_img_dir):
        app.mount("/api/robot_img", StaticFiles(directory=robot_img_dir), name="robot_img")
